...
```{r echo=FALSE}
ggplot(data = pd, aes(x = factor(race), y = Extraversion, col = Sex)) +
  geom_boxplot() +
...
```{r echo=FALSE}
ggplot(data = pd, aes(x = factor(race), y = Neuroticism, col = Sex)) +
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90))
```
...
```{r echo=FALSE}
ggplot(data = pd, aes(x = factor(race), y = Agreeableness, col = Sex)) +
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90))
```
...
```{r echo=FALSE}
ggplot(data = pd, aes(x = factor(race), y = Conscientiousness, col = Sex)) +
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90))
```
...
```{r echo=FALSE}
ggplot(data = pd, aes(x = factor(race), y = Openness, col = Sex)) +
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90))
```
